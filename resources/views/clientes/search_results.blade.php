            ...
            @foreach($autos as $auto)
                <div class="col-md-4">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">{{ $auto->modelo }} - {{ $auto->marca->nombre_marca }}</h5>
                            <p class="card-text">${{ $auto->precio_por_dia }} USD por día</p>
                            <a href="{{ route('cliente.autos.show', $auto->id_auto) }}" class="btn btn-primary">Ver Detalles</a>
                        </div>
                    </div>
                </div>
            @endforeach
